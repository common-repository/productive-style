...
function productive_style_register_block_init_blog_element() {
    ...
    $asset_file = include( PRODUCTIVE_STYLE_PLUGIN_PATH . 'includes/common/gutenberg/blocks/blog-element/build/index.asset.php');
    
    wp_register_script(
        'productive-style-blog-element-script',
        PRODUCTIVE_STYLE_PLUGIN_URI . 'includes/common/gutenberg/blocks/blog-element/build/index.js',
    ...
    wp_register_style(
        ...
        PRODUCTIVE_STYLE_PLUGIN_URI . 'includes/common/gutenberg/blocks/blog-element/build/style-index.css',
        array(),
        $productive_style_plugin_version
    );
    
    $block_metadata = PRODUCTIVE_STYLE_PLUGIN_PATH . 'includes/common/gutenberg/blocks/blog-element/build';
    $args = array(
        'api_version' => 3,
