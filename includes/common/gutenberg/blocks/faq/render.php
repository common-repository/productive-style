...
function productive_style_register_block_init_faq() {
    ...
    $asset_file = include( PRODUCTIVE_STYLE_PLUGIN_PATH . 'includes/common/gutenberg/blocks/faq/build/index.asset.php');
    
    wp_register_script(
        'productive-style-faq-script',
        PRODUCTIVE_STYLE_PLUGIN_URI . 'includes/common/gutenberg/blocks/faq/build/index.js',
    ...
    wp_register_style(
        ...
        PRODUCTIVE_STYLE_PLUGIN_URI . 'includes/common/gutenberg/blocks/faq/build/style-index.css',
        array(),
        $productive_style_plugin_version
    );
    
    $block_metadata = PRODUCTIVE_STYLE_PLUGIN_PATH . 'includes/common/gutenberg/blocks/faq/build';
    $args = array(
        'api_version' => 3,
...
function productive_style_register_block_render_callback_faq( $attributes, $content ) {
    ...
    $cpt_section_args = array(
        ...
        'section_toggle_button_location'                        => $attributes['section_toggle_button_location'],
