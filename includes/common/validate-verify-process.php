...
function productive_style_validate_input_hex_color( $color ) {
...
function productive_style_get_validate_input_default( $value ) {
    return strip_tags( stripslashes($value) );
}

function productive_style_get_validate_input_wpeditor( $value ) {
    return stripslashes($value);
}

function productive_style_get_is_validate_email_addresses( $emails_string ) {
...
function productive_style_get_is_valid_phone_number( $phone, $is_required = false ) {
...
function productive_style_get_date( $date_string ) {
